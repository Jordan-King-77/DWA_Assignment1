...
namespace DWA_Assignment1.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> FindUserResults(string email)
        {
            if (email == null)
            {
        ...
        //GET: Edit User
        [Authorize(Roles = "Club Official,Parent")]
        public ViewResult EditUser(string email)
        {
            ViewBag.EditUserEmail = email;
        ...
        public async Task<ActionResult> EditUser(RegisterViewModel model)
        {
            ...
            if (model.SelectedRole != null)
            {
                ...
                deleteList[0] = "Club Official";
                deleteList[1] = "Swimmer";
                deleteList[2] = "Parent";

                UserManager.RemoveFromRoles(user.Id, deleteList);
                UserManager.AddToRole(user.Id, model.SelectedRole);
            }
        ...
        //GET: Archive User
        [Authorize(Roles = "Club Official")]
        public async Task<ActionResult> ArchiveUser(string email)
        {
            if (email == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
